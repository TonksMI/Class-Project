...
var render = function () {
	...
	context.fillText(score.toString(), 200, 0, 200);
	player.render();
	computer.render();
	ball.render();
};
...
function outNode(a, b,  var1, var2, var, var3, var4, var5, var6, var7, var8, var9, var10, var11, var12)
{
  this.a = a;
  this.b = b;
  ...
  {
    return a * node1.outputNum() + b * node2.outputNum();
  };
...
function population ()
{
  this.n1 = outNode(GaussianDist(0, 5), GaussianDist(0, 5),GaussianDist(0, 5),GaussianDist(0, 5),GaussianDist(0, 5),GaussianDist(0, 5),GaussianDist(0, 5),GaussianDist(0, 5),GaussianDist(0, 5),GaussianDist(0, 5),GaussianDist(0, 5),GaussianDist(0, 5),GaussianDist(0, 5),GaussianDist(0, 5));
  this.n2 = outNode(GaussianDist(0, 5), GaussianDist(0, 5),GaussianDist(0, 5),GaussianDist(0, 5),GaussianDist(0, 5),GaussianDist(0, 5),GaussianDist(0, 5),GaussianDist(0, 5),GaussianDist(0, 5),GaussianDist(0, 5),GaussianDist(0, 5),GaussianDist(0, 5),GaussianDist(0, 5),GaussianDist(0, 5));
	this.node = 0;
